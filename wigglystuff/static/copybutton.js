  ...
  "node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
      ...
      function requestUpdateLane(fiber) {
        if ((executionContext & RenderContext2) !== NoContext && 0 !== workInProgressRootRenderLanes)
      ...
      function scheduleUpdateOnFiber(root2, fiber, lane) {
        ...
        if (0 !== (executionContext & RenderContext2) && root2 === workInProgressRoot) {
          if (isRendering)
            switch (fiber.tag) {
              case 0:
              case 11:
          ...
          isDevToolsPresent && addFiberToLanesMap(root2, fiber, lane), warnIfUpdatesNotWrappedWithActDEV(fiber), root2 === workInProgressRoot && ((executionContext & RenderContext2) === NoContext && (workInProgressRootInterleavedUpdatedLanes |= lane), workInProgressRootExitStatus === RootSuspendedWithDelay && markRootSuspended(
            root2,
            workInProgressRootRenderLanes,
            workInProgressDeferredLane,
            false
      ...
      function flushSyncWork$1() {
        return (executionContext & (RenderContext2 | CommitContext)) === NoContext ? (flushSyncWorkAcrossRoots_impl(0, false), false) : true;
      }
      ...
      function pingSuspendedRoot(root2, wakeable, pingedLanes) {
        ...
        workInProgressRoot === root2 && (workInProgressRootRenderLanes & pingedLanes) === pingedLanes && (workInProgressRootExitStatus === RootSuspendedWithDelay || workInProgressRootExitStatus === RootSuspended && (workInProgressRootRenderLanes & 62914560) === workInProgressRootRenderLanes && now$1() - globalMostRecentFallbackTime < FALLBACK_THROTTLE_MS ? (executionContext & RenderContext2) === NoContext && prepareFreshStack(root2, 0) : workInProgressRootPingedLanes |= pingedLanes, workInProgressSuspendedRetryLanes === workInProgressRootRenderLanes && (workInProgressSuspendedRetryLanes = 0));
        ensureRootIsScheduled(root2);
      }
      ...
      function scheduleImmediateTask(cb) {
        ...
        scheduleMicrotask(function() {
          (executionContext & (RenderContext2 | CommitContext)) !== NoContext ? scheduleCallback$3(ImmediatePriority, cb) : cb();
        });
      }
                  ...
                  case 3:
                    ...
                    if (fiber.current.memoizedState.isDehydrated) {
                      ...
                      if (0 !== lanes) {
                        ...
                        (executionContext & (RenderContext2 | CommitContext)) === NoContext && (workInProgressRootRenderTargetTime = now$1() + RENDER_TIMEOUT_MS, flushSyncWorkAcrossRoots_impl(0, false));
                      }
                    }
                    break;
                  case 13:
      ...
      ReactDOMHydrationRoot.prototype.unmount = ReactDOMRoot.prototype.unmount = function(JSCompiler_OptimizeArgumentsArray_p3) {
        ...
        if (null !== JSCompiler_OptimizeArgumentsArray_p3) {
          ...
          (executionContext & (RenderContext2 | CommitContext)) !== NoContext && console.error(
...
function useRenderContext() {
  ...
  if (!ctx)
    throw new Error("RenderContext not found");
  return ctx;
}
function useModel() {
...
function CopyToClipboardButton() {
  ...
  return /* @__PURE__ */ React2.createElement("div", { className: "copy-button-wrapper" }, /* @__PURE__ */ React2.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React2.createElement(CopyIcon, { className: "copy-button-icon" }),
    "Copy to Clipboard"
  ));
}
